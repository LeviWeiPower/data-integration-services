...
import com.aimspeed.test.ApplicationRun;
...
public class BaseTest {
	...
	private String [] names = new String[] {"小李子","小掌","小圣","小和","小你"};
	private String [] introduces = new String[] {"初中 宋·李清照 常记溪亭日暮，沉醉不知归路，兴尽晚回舟，误入藕花深处。争渡，争渡","重阳节 宋·李清照 薄雾浓云愁永昼，瑞脑消金兽。佳节又重阳，玉枕纱厨，半夜凉初透。东"
	...
	public String getIntroduces() {
		Double introducesIndex = introduces.length * Math.random();
		return introduces[introducesIndex.intValue()];
	}
