 ...
 * @date  2018年7月25日 
 */
public abstract class BaseSolrMapperImpl<T extends Serializable> implements BaseSolrMapper<T> {
	 ...
	 */
	@Override
	public SolrPageVo<T> queryPage(Integer curPage, Integer pageSize,String orderField, String orderingRule,String query) {
		//为空，则默认查询所有
        ...
        if(null != orderingRule && !"".equals(orderingRule.trim())) {
        	...
        	if(null != orderingRule && RepositorySearchConstant.SORT_DESC.equalsIgnoreCase(orderingRule)) {
        ...
        //查询出来的数据
  		SolrPageVo<T> page = new SolrPageVo<>();
  		page.setFristPage(1);
...
//  		page.setFiltrate();//保留筛选条件
	 ...
	 */
	@Override
	public SolrPageVo<T> queryPage(Integer curPage, Integer pageSize,String orderField, String orderingRule, Map<String, Object> filtrate, Map<String, Object> likeFiltrate) {
		//拼接查询字符串
		...
		//查询数据
		SolrPageVo<T> solrPageVo = queryPage(curPage, pageSize, orderField, orderingRule, query);
	 ...
	 */
	@Override
	public SolrPageVo<T> queryPageToDefaulHighlight(Integer curPage, Integer pageSize,String orderField, String orderingRule,String highlightField,String query) {
		//为空，则默认查询所有
		SolrQuery solrQuery = new SolrQuery();
...
//		solrQuery.addHighlightField(highlightField);
	 ...
	 * 因为查询的是高亮，根据结果进行组装
	 * @author AimSpeed
	 * @Title queryPageAssembleResult 
	 * @param pageVo
	 * @return PageVo<T> 
	 * @date 2018年7月27日
	 */
	protected abstract SolrPageVo<T> queryPageAssembleResult(Integer curPage, Integer pageSize,String orderField, String orderingRule,boolean highlight,QueryResponse queryResponse);
	 ...
	 */
	@Override
	public SolrPageVo<T> queryPageToHighlight(Integer curPage, Integer pageSize, String orderField,
		...
		//查询数据
		SolrPageVo<T> solrPageVo = queryPageToHighlight(curPage, pageSize, orderField,
	 ...
	 * @param query
	 * @return SolrPageVo<T>  
	 * @date 2018年9月27日 下午11:16:38
	 */
	protected abstract SolrPageVo<T> queryPageToHighlight(Integer curPage, Integer pageSize, String orderField,
