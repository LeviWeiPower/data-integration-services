 ...
 * @author AimSpeed
 */
public abstract class BaseMySqlServiceImpl<T extends Serializable> implements BaseMySqlService<T> {
	 ...
	 */
	@Override
	public MySqlPageVo<T> selectPageSelective(int curPage, int pageSize, String orderField, String orderingRule,
			Map<String,Object> filtrate,Map<String,Object> likeFiltrate) {
		MySqlPageVo<T> pageVo = new MySqlPageVo<>();
		...
		MySqlPageVo<T> page = new MySqlPageVo<>();
		page.setFristPage(1);
	 ...
	 */
	@Override
	public List<T> selectPageSelective(MySqlPageVo<T> pageVo) {
