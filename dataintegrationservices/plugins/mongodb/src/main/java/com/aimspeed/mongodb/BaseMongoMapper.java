...
public interface BaseMongoMapper<T> {
	 ...
	 * @return T 
	 */
	<T> T queryOfOnly(T t,Class<T> clazz);
	 ...
	 * @return T 
	 */
	<T> T queryOfOnly(Class<T> clazz,Map<String, Object> filtrate, Map<String, Object> likeFiltrate);
	 ...
	 * @return PageVo<T>  
	 */
	MongoPageVo<T> queryPage(int curPage, int pageSize,
	 ...
	 */
	MongoPageVo<T> queryPage(MongoPageVo<T> pageVo);
